...
export type StockItemOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"productId" | "quantity" | "updatedAt", ExtArgs["result"]["stockItem"]>
...
export interface StockItemDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const stockItemWithProductIdOnly = await prisma.stockItem.findMany({ select: { productId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many StockItems and only return the `productId`
   * const stockItemWithProductIdOnly = await prisma.stockItem.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more StockItems and only return the `productId`
   * const stockItemWithProductIdOnly = await prisma.stockItem.updateManyAndReturn({
   *   select: { productId: true },
   *   where: {
   *     // ... provide filter here
   *   },
